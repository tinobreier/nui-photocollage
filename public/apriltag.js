// Get the base URL of this worker script to load relative resources
const workerLocation = self.location.href.substring(0, self.location.href.lastIndexOf('/') + 1);
importScripts(workerLocation + 'apriltag_wasm.js');
